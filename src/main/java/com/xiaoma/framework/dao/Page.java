package com.xiaoma.framework.dao;
...
public class Page<T> {
	...
	public Page<T> pageNo_bak(final int thePageNo) {
		setPageNo(thePageNo);
		return this;
	}
	...
	public Page<T> pageSize_bak(final int thePageSize) {
	...
	public void setOrder(final String order) {
		...
		for (String orderStr : orders) {
			if (!StringUtils.equalsIgnoreCase(SortBy.DESC.toString(), orderStr) && !StringUtils.equalsIgnoreCase(SortBy.ASC.toString(), orderStr)) {
