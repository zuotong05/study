...
public class TableInfo {
	...
	public void addColumn(ColumnInfo column) {
		...
		if (!columns.contains(column)) {
			...
			addFiled(new FieldInfo(javaType, name, column.getComment()));
		}
	}
	...
	public String getInsertMapModel() {
		...
		sb.append(TAB3).append("#{id,jdbcType=BIGINT}").append(")");		
		return sb.toString();
	}
	...
	public String getUpdateStatement() {
		...
		sb.append(" where " + primaryKey + "=#{id,jdbcType=BIGINT}");
		return sb.toString();
	}
	...
	public String getUpdateMapModel() {// 动态字段更新
		...
		sb.append(TAB2 + "</set>" + ENDL);
		sb.append(TAB2 + " where " + primaryKey + "=#{id,jdbcType=BIGINT}");
		return sb.toString();
	}
}
