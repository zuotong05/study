...
public class HttpClientUtils {
	...
	public static String postJSON(String url, String jsonData) throws ConnectTimeoutException, SocketTimeoutException, Exception {
		return postJSON(url, jsonData, charset, connTimeout, readTimeout);
	}

	public static String postJSON(String url, String jsonData, String charset, Integer connTimeout, Integer readTimeout) throws ConnectTimeoutException, SocketTimeoutException, Exception {
		return post(url, jsonData, CONTENT_TYPE_JSON, charset, connTimeout, readTimeout);
	}

	public static String postParameters(String url, String parameterStr) throws ConnectTimeoutException, SocketTimeoutException, Exception {
		return postParameters(url, parameterStr, charset, connTimeout, readTimeout);
	}

	public static String postParameters(String url, String parameterStr, String charset, Integer connTimeout, Integer readTimeout) throws ConnectTimeoutException, SocketTimeoutException, Exception {
		return post(url, parameterStr, CONTENT_TYPE_FORM_URLENCODED, charset, connTimeout, readTimeout);
	}
	...
	public static String postMap(String url, Map<String, String> params, Map<String, String> headers) throws Exception {
		String str = postForm(url, params, headers, connTimeout, readTimeout);
		return str;
	}

	public static String getMap(String url, Map<String, String> headers) throws Exception {
		String str = get(url, headers, charset, connTimeout, readTimeout);
		return str;
	}
