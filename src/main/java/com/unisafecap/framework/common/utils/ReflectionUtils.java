...
public class ReflectionUtils {
	...
	public static Object convertStringToObject(String value, Class<?> toType) {
		try {
			if (toType.isAssignableFrom(Boolean.class) || toType.isAssignableFrom(boolean.class)) {
				logger.debug("boolean转化{}", value);
				if (StringUtils.isNotBlank(value) && ("是".equals(value) || "1".contains(value)))
					return true;
				if (StringUtils.isNotBlank(value) && ("否".equals(value) || "0".contains(value)))
					return false;
