...
public class PageDto<T> {
	...
	public PageDto<T> pageNo_bak(final int thePageNo) {
		setPageNo(thePageNo);
		return this;
	}
	...
	public PageDto<T> pageSize_bak(final int thePageSize) {
	...
	public PageDto<T> orderBy(final String theOrderBy) {
	...
	public PageDto<T> order(final String theOrder) {
		setOrder(theOrder);
		return this;
	}
