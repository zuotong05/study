 ...
 * @version V1.0  
 */
public class RiskLoanApply extends BaseModel implements Serializable {
    /**
     * 合作机构编号
     */
     ...
     * 信托项目简码
     */
    private String trustPojectCode;
    /**
     * 合同号
     */
    ...
    public String getTrustPojectCode() {
        return trustPojectCode;
    }

    public void setTrustPojectCode(String trustPojectCode) {
        this.trustPojectCode = trustPojectCode;
    }
