...
public class RiskLoanApplyDto implements Serializable {

	private static final long serialVersionUID = 2921907606655876761L;
	 ...
	 * 个人用户信息
	 */
	private RiskLoanUserDto loanUser;

	/**
	 * 关系人信息
	 */
	private List<RiskRelationUserDto> relationUsers;

	/**
	 * 放款账户信息
	 */
	private RiskLoanAccountDto loanAccount;
	...
	public RiskLoanUserDto getLoanUser() {
		return loanUser;
	}

	public void setLoanUser(RiskLoanUserDto loanUser) {
		this.loanUser = loanUser;
	}

	public List<RiskRelationUserDto> getRelationUsers() {
		return relationUsers;
	}

	public void setRelationUsers(List<RiskRelationUserDto> relationUsers) {
		this.relationUsers = relationUsers;
	}

	public RiskLoanAccountDto getLoanAccount() {
		return loanAccount;
	}

	public void setLoanAccount(RiskLoanAccountDto loanAccount) {
